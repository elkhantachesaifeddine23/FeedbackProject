...
export default function AuthenticatedLayout({ user, header, children }) {
    ...
    const navigation = [
        ...
        { name: 'Abonnement', href: 'billing.index', icon: CreditCardIcon, current: route().current('billing.*'), enabled: true, section: 'config' },
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="border-b border-gray-200">
                        <Link href={route('dashboard')} className="flex items-center justify-center px-5 py-5">
                            <img src="/images/logo_Luminea2.png" alt="Luminea" className="h-24 w-auto object-contain transition-transform duration-200 hover:scale-105" />
                        </Link>
                    </div>
